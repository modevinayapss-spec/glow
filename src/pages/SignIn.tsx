      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-serif italic text-ink">Welcome <span className="not-italic font-light text-rose-500">Back</span></h2>
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-ink/30">Sign in to your Glow Sense AI account</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSignIn} className="space-y-6">
          ...
          <p className="text-center text-[10px] font-bold uppercase tracking-widest text-ink/30">
            Don't have an account? <button type="button" onClick={() => navigate("/signup")} className="text-rose-500 hover:underline">Sign Up</button>
          </p>
        </form>

        <div className="pt-6 border-t border-black/5">
           <div className="bg-rose-50/50 p-6 rounded-3xl border border-rose-100/50 space-y-3">
              <span className="text-[8px] font-black uppercase tracking-widest text-rose-300">Demo Accounts:</span>
              <div className="space-y-1 text-[10px] font-bold text-rose-900/40 text-center">
                 <p>Admin: admin@glowsense.com / admin123</p>
